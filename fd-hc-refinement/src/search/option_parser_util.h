...
template <>
struct TypeNamer<MergeCriterion *> {
    static std::string name() {
        return "merge criterion";
    }
};
...
template <>
struct TypeNamer<HeuristicRefiner *> {
    static std::string name() {
        return "HeuristicRefiner";
    }
};

template <>
struct TypeNamer<UCClauseExtraction *> {
    static std::string name() {
        return "UCClauseExtraction";
    }
};

template <>
struct TypeNamer<RNMap *> {
    static std::string name() {
        return "RNMap";
    }
};
...
template <>
struct TypeNamer<SearchRestartStrategy *> {
    static std::string name() {
        return "SearchRestartStrategy";
    }
};

template <>
struct TypeNamer<tarjan_dfs::OpenListFactory *> {
    static std::string name() {
        return "tarjan_dfs::OpenListFactory";
    }
};
