...
ShrinkNone::ShrinkNone(const Options &opts) : ShrinkStrategy(opts),
...
static ShrinkStrategy *_parse(OptionParser &parser) {
    ...
    parser.add_enum_option(
        ...
        "catch all, all goal leading or all goal leading with backward pruning actions", "false");
