...
public:
    ...
    */
    ...
    void set_atomic_abstractions(const std::vector<Abstraction *> atomic_abstractions_){
    ...
    virtual const std::vector<bool> &get_caught_labels_set() const {return labels_set;}
