small = [
    "-DPLUGIN_STUBBORNSETS_EC_ENABLED=FALSE",
    "-DPLUGIN_MS_ENABLED=FALSE",
    "-DPLUGIN_PDB_ENABLED=FALSE",
    "-DPLUGIN_POTENTIALS_ENABLED=FALSE",
]

release32 = ["-DCMAKE_BUILD_TYPE=Release"] + small
debug32 = ["-DCMAKE_BUILD_TYPE=Debug"] + small
