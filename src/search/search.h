...
protected:
    ...
    OpenSet *m_open_set;
    std::vector<Heuristic *> m_heuristics;// vector of used heuristic
    std::vector<Heuristic *> m_preferred; // vector preferred heuristic
    std::vector<HeuristicRefiner *> m_heuristic_refiner; // a vector of refiner 
    std::set<Heuristic *> m_underlying_heuristics;//a set of heuristic
    Heuristic *m_cached_h;// a heuristic
    ...
    int m_smallest_h; // this will be used -- the heuristic and g_value may be not stored
    int m_largest_g;  // this will be used
