...
private:
    ...
    int u_recognized_dead_ends;

    int search_restarts;
    int search_backtracks;
...
public:
    ...
    void inc_u_recognized_dead_ends(int inc = 1) {u_recognized_dead_ends += inc; }
    void inc_restarts(int inc = 1) {search_restarts += inc; }
    void inc_backtracks(int inc = 1) {search_backtracks += inc; }
    ...
    int get_u_recognized_dead_ends() const { return u_recognized_dead_ends; }
    int get_restarts() const {return search_restarts; }
    int get_backtracks() const {return search_backtracks; }
