...
template <>
class TokenParser<HeuristicRefiner *> {
public:
    static inline HeuristicRefiner *parse(OptionParser &p);
};

template <>
class TokenParser<UCClauseExtraction *> {
public:
    static inline UCClauseExtraction *parse(OptionParser &p);
};

template <>
class TokenParser<RNMap *> {
public:
    static inline RNMap *parse(OptionParser &p);
};

template <>
class TokenParser<SearchRestartStrategy *> {
public:
    static inline SearchRestartStrategy *parse(OptionParser &p);
};

template <>
class TokenParser<tarjan_dfs::OpenListFactory *> {
public:
  static inline tarjan_dfs::OpenListFactory *parse(OptionParser &p);
};
...
HeuristicRefiner *TokenParser<HeuristicRefiner *>::parse(OptionParser &p) {
    return lookup_in_registry<HeuristicRefiner>(p);
}

UCClauseExtraction *TokenParser<UCClauseExtraction *>::parse(OptionParser &p) {
    return lookup_in_registry<UCClauseExtraction>(p);
}

RNMap *TokenParser<RNMap *>::parse(OptionParser &p) {
    return lookup_in_registry<RNMap>(p);
}

SearchRestartStrategy *TokenParser<SearchRestartStrategy *>::parse(OptionParser &p) {
    return lookup_in_registry<SearchRestartStrategy>(p);
}

tarjan_dfs::OpenListFactory *TokenParser<tarjan_dfs::OpenListFactory *>::parse(OptionParser &p) {
  return lookup_in_registry<tarjan_dfs::OpenListFactory>(p);
}
...
operator_counting::ConstraintGenerator *TokenParser<operator_counting::ConstraintGenerator *>::parse(OptionParser &p) {
  return lookup_in_registry<operator_counting::ConstraintGenerator>(p);
}
